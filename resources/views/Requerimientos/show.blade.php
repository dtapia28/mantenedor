            ...
            <div class="ibox">
                <div class="ibox-head">
                    ...
                    <div class="pull-right">
                        <a class="btn btn-primary" href="{{ url('requerimientos/'.$requerimiento->id.'/log') }}" style="white-space: normal;"><i class="fa fa-check"></i>Log de requerimiento</a>
                    </div>
                    @endif
                    @endif
                </div>                            
                ...
                @endif
                @endif
                @if($user[0]->nombre=="administrador" and $requerimiento->aprobacion == 4)
                <div class="ibox-head">
                    <div class="ibox-title">Datos del Requerimiento</div>
                    <div class="pull-right"><a class="btn btn-primary" onclick="return confirm('¿Estás seguro/a de autorizar el cierre del requerimiento?')" href="{{ url('requerimientos/'.$requerimiento->id.'/aceptar') }}" style="white-space: normal;"><i class="fa fa-check"></i> Aceptar</a> <a class="btn btn-outline-danger" href="{{ url('requerimientos/'.$requerimiento->id.'/rechazar') }}" style="white-space: normal;"><i class="fa fa-close"></i> Rechazar</a></div>
                </div>
                ...
                <div class="ibox-body">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <br>
                            <h2>Envío detalle de requerimiento</h2>
                            <br>
                                <form method="POST" action="{{ url('requerimientos/'.$requerimiento->id.'/mail_info') }}">
                                    {{ csrf_field() }}
                                        <label for="input_email">Indica email(s) para envío:</label>
                                        <input name="input_email" type="text" class="form-control col-md-3">
                                        <br>
