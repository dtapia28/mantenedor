					...
					<li class="dropdown dropdown-user">
						<a class="nav-link dropdown-toggle link" data-toggle="dropdown">
							...
							<div class="admin-info">
								...
								<small>{{ ucfirst($user->nombre) }}</small>
							</div>
						</a>
		...
		<nav class="page-sidebar" id="sidebar">
			<div id="sidebar-collapse">
				...
				<ul class="side-menu metismenu">
					@if(in_array($user->nombre, ["supervisor", "administrador", "solicitante", "resolutor"]))
					<li id="mTablero">
					...
					@endif
					@if(in_array($user->nombre, ["administrador"]))
					<li id="mIndicadores">
					...
					<li id="mRequerimientos">
						<a href="{{ url('/requerimientos') }}"><i class="sidebar-item-icon fa fa-address-card"></i>
							<span class="nav-label">Requerimientos</span>
                                        ...
                                        @if(in_array($user->nombre, ["supervisor", "resolutor"]))
					<li id="mDate">
					...
					@endif
					@if($user->nombre == "supervisor" or $user->nombre == "administrador")
					<li id="mExportar">
