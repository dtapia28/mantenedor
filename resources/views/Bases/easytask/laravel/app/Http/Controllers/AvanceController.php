...
class AvanceController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($request->input("fechaRealCierre") != null) {
            $requerimiento = DB::table('requerimientos')->select('numeroCambios', 'id')->where('id', $request->input("idRequerimiento"))->first();
            ...
            $requerimiento = DB::table('requerimientos')->select('fechaRealCierre', 'id')->where('id', $request->input("idRequerimiento"))->first();
