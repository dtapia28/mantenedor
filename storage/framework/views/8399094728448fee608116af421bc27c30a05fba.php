					...
					<li class="dropdown dropdown-user">
						<a class="nav-link dropdown-toggle link" data-toggle="dropdown">
							...
							<div class="admin-info">
								...
								<small><?php echo e(ucfirst($user[0]->nombre)); ?></small>
							</div>
						</a>
						<ul class="dropdown-menu dropdown-menu-right">
							...
							<?php endif; ?>
							<a class="dropdown-item" href="<?php echo e(url('user/changepassword')); ?>"><i class="fa fa-lock"></i> Cambiar contraseña</a>
		...
		<nav class="page-sidebar" id="sidebar">
			<div id="sidebar-collapse">
				...
				<ul class="side-menu metismenu">
					<?php if(in_array($user[0]->nombre, ["supervisor", "administrador", "solicitante"])): ?>
					<li id="mTablero">
						<a class="active" href="<?php echo e(url('/dashboard')); ?>"><i class="sidebar-item-icon fa fa-th-large"></i>
...
<?php /**PATH C:\xampp\htdocs\Mantenedor\resources\views/Bases/dashboard.blade.php ENDPATH**/ ?>