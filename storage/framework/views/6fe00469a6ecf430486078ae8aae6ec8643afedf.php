...
if (isset($messageCache)) { $message = $messageCache; }
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                <input id="n_telefono" class="form-control" type="text" title="Si es que desea que el sistema le pueda enviar mensajes via WhatsApp." class="md-form-control <?php if ($errors->has('n_telefono')) :
if (isset($message)) { $messageCache = $message; }
...
<?php echo $__env->make('Bases.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/kinchika/public_html/laravel/resources/views/Users/create.blade.php ENDPATH**/ ?>