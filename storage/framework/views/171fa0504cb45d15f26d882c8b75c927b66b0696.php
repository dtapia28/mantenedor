                            ...
                            <div class="tab-pane fade show active" id="tab-1">
                                ...
                                <ul class="media-list media-list-divider m-0">
                                    ...
                                    <li class="media">
                                        ...
                                        <div class="media-body">
                                            <div class="media-heading text-warning">Requerimientos por vencer <div class="float-right text-dark h4 m-0"><?php echo e($vencer); ?></div></div>
                                        </div>
                                    </li>
                                    <li class="media">
                                        <div class="media-img"><i class="ti-reload font-18 text-muted"></i></div>
                                        <div class="media-body">
                                            <div class="media-heading text-danger">Requerimientos vencidos <div class="float-right text-dark h4 m-0"><?php echo e($vencido); ?></div></div>
                                        </div>
                                    </li>                                    
                                </ul>
                            </div>
...
<?php echo $__env->make('Bases.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Mantenedor\resources\views/Indicadores/index.blade.php ENDPATH**/ ?>