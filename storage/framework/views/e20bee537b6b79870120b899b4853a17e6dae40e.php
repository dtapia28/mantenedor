		...
		<nav class="page-sidebar" id="sidebar">
			<div id="sidebar-collapse">
				...
				<ul class="side-menu metismenu">
					<?php if(in_array($user[0]->nombre, ["supervisor", "administrador", "solicitante", "resolutor"])): ?>
					<li id="mTablero">
...
</html><?php /**PATH /home1/kinchika/public_html/laravel/resources/views/Bases/dashboard.blade.php ENDPATH**/ ?>