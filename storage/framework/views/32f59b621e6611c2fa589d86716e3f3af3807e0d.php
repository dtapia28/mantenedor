...
if (isset($messageCache)) { $message = $messageCache; }
                        ...
                        <div class="form-group row">
                            <label for="rut" class="col-md-4 col-form-label text-md-right"><?php echo e(__('Rut Empresa')); ?></label>
                            <div class="col-md-6">
                            <input id="rut" type="text" class="form-control <?php if ($errors->has('rut')) :
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('rut'); ?> no es valido <?php unset($message);
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" name="rut" value="<?php echo e(old('rut')); ?>">
                            </div>                       
                        </div>
                        <div class="form-group row">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/itconsul/public_html/easytask/laravel/resources/views/auth/register.blade.php ENDPATH**/ ?>