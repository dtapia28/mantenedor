				...
				<table class="table table-bordered table-striped table-hover" id="dataTable"width="100%"  cellspacing="0">
					...
					<tbody>
						...
						<tr>
							...
							<form method='HEAD' action="<?php echo e(url('resolutors/'.$resolutor->id.'/editar')); ?>">
...
<?php echo $__env->make('Bases.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/kinchika/public_html/laravel/resources/views/Resolutors/index.blade.php ENDPATH**/ ?>