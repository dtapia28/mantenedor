<?php $__env->startSection('css'); ?>
	<link href="<?php echo e(asset('vendor/DataTables/Excel/datatables.min.css')); ?>" rel="stylesheet" />
...
<div class="ibox">
	...
	<div class="ibox-body" align="center">
		<div class="row">
			<?php for($i=0; $i<count((array)$data["arrayEquipos"]); $i++): ?>
			<div class="col-md-3">
				<div id="chart-medidor-eq<?php echo e($i); ?>" style="min-height:30vh;"></div>
			</div>
			<?php endfor; ?>
		</div>
        </div>
...
<?php $__env->startSection('scripts_dash'); ?>
	<script src="<?php echo e(asset('vendor/DataTables/Excel/datatables.min.js')); ?>" type="text/javascript"></script>
	<script type="text/javascript">
		$(document).ready(function(){
			...
			<?php if(isset($data)): ?>
				<?php if($data['rango_fecha'] == "por_rango"): ?>
...
<?php $__env->stopSection(); ?>
<?php /**PATH /home1/kinchika/public_html/laravel/resources/views/dashboard/administrador.blade.php ENDPATH**/ ?>