    ...
    <div class="row">
        <div class="col-md-12">
            <div class="ibox">
                ...
                <div class="ibox-body"> 
					<form method="POST" action="<?php echo e(url('user/account/guardar')); ?>" enctype="multipart/form-data">
						<?php echo e(csrf_field()); ?>

						<div class="form-group row">
							<label for="supervisor" class="col-md-2 text-md-right">Nombre</label>
							<div class="col-md-5">
								<input value="<?php echo e($nombre); ?>" class="form-control" type="text" name="nombre" id="nombre" readonly>
							</div>
						</div>
						<div class="form-group row">
							<label for="supervisor" class="col-md-2 text-md-right">Email</label>
							<div class="col-md-5">
								<input value="<?php echo e($email); ?>" class="form-control" type="text" name="email" id="email" readonly>
							</div>
						</div>
						<div class="form-group row">
...
<?php echo $__env->make('Bases.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/kinchika/public_html/laravel/resources/views/Users/micuenta.blade.php ENDPATH**/ ?>